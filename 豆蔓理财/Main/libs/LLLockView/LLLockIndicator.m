...
#define kCircleDiameter (self.bounds.size.height)/4           // 圆点直径
#define kCircleMargin   (self.bounds.size.height)/8              // 圆点间距
...
- (void)initCircles
{
    ...
    for (int i=0; i<9; i++) {
        ...
        [button setBackgroundImage:[UIImage imageNamed:@"small-1"] forState:UIControlStateNormal];
        [button setBackgroundImage:[UIImage imageNamed:@"small-2"] forState:UIControlStateSelected];
        [button setBackgroundImage:[UIImage imageNamed:@"small-2"] forState:UIControlStateHighlighted];
