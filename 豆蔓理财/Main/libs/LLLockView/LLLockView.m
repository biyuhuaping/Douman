...
#define kCircleMargin DMDeviceWidth*32.0/375.0              // 圆点离屏幕左边距
#define kCircleDiameter DMDeviceWidth*68.0/375.0            // 圆点直径
#define kLLCircleAlpha 1.0              // 圆点透明度
#define kLLLineWidth 2.0               // 线条宽
#define kLLLineColor MainGreen // 线条绿色
#define kLLLineColorWrong MainRed // 线条色红
...
//        LLLog(@"每个圆点位置 %d,%d", x, y);
        ...
        [button setBackgroundImage:[UIImage imageNamed:@"quan-1"] forState:UIControlStateNormal];
        [button setBackgroundImage:[UIImage imageNamed:@"quan-2"] forState:UIControlStateSelected];
        [button setBackgroundImage:[UIImage imageNamed:@"quan-2"] forState:UIControlStateHighlighted];
...
- (void)showErrorCircles:(NSString*)string
{
    ...
    for (UIButton* button in buttonArray) {
        if (button.selected) {
            [button setBackgroundImage:[UIImage imageNamed:@"quan-2Sel"] forState:UIControlStateSelected];
            [button setBackgroundImage:[UIImage imageNamed:@"quan-2Sel"] forState:UIControlStateHighlighted];
        }
